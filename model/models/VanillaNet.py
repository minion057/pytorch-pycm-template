...
- Papaer: https://arxiv.org/pdf/2305.12972v2.pdf
- Official Code: https://github.com/huawei-noah/VanillaNet/blob/main/models/vanillanet.py

- The models used in the paper are all.
- An issue with BatchNorm2d arises when the batch size is set to 1.
"""
...
class VanillaNet(BaseModel): #(nn.Module):
